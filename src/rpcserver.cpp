...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Prius features */
        {"prius", "masternode", &masternode, true, true, false},
        {"prius", "listmasternodes", &listmasternodes, true, true, false},
        {"prius", "getmasternodecount", &getmasternodecount, true, true, false},
        {"prius", "masternodeconnect", &masternodeconnect, true, true, false},
        {"prius", "masternodecurrent", &masternodecurrent, true, true, false},
        {"prius", "masternodedebug", &masternodedebug, true, true, false},
        {"prius", "startmasternode", &startmasternode, true, true, false},
        {"prius", "createmasternodekey", &createmasternodekey, true, true, false},
        {"prius", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"prius", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"prius", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"prius", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"prius", "getmasternodescores", &getmasternodescores, true, true, false},
        {"prius", "mnbudget", &mnbudget, true, true, false},
        {"prius", "preparebudget", &preparebudget, true, true, false},
        {"prius", "submitbudget", &submitbudget, true, true, false},
        {"prius", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"prius", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"prius", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"prius", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"prius", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"prius", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"prius", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"prius", "checkbudgets", &checkbudgets, true, true, false},
        {"prius", "mnsync", &mnsync, true, true, false},
        {"prius", "spork", &spork, true, true, false},
        {"prius", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"prius", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use priusd, or the -server option to prius-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> prius-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12882/\n";
}
