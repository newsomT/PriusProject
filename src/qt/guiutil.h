...
/** Utility functions used by the Prius Qt UI.
 */
namespace GUIUtil
{
...
// Render Prius addresses in monospace font
...
// Parse "prius:" URI into recipient object, return true on successful parsing
