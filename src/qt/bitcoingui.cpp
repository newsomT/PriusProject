                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Prius Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Prius address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and prius: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Prius Core"), this);
    aboutAction->setStatusTip(tr("Show information about Prius Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Prius"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Prius addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Prius addresses"));
    ...
    openAction->setStatusTip(tr("Open a Prius: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Prius Core help message to get a list with possible Prius command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Prius Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Prius network", "", count));
}
...
{
    QString strTitle = tr("Prius Core"); // default title
