...
std::list<std::string> ZPrxControlDialog::listSelectedMints;
std::list<CZerocoinMint> ZPrxControlDialog::listMints;
...
void ZPrxControlDialog::updateLabels()
{
    ...
    privacyDialog->setZPrxControlLabels(nAmount, listSelectedMints.size());
}

std::vector<CZerocoinMint> ZPrxControlDialog::GetSelectedMints()
{
