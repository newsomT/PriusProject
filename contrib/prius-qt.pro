...
RESOURCES += src/qt/prius.qrc src/qt/prius_locale.qrc

TRANSLATIONS += src/qt/locale/prius_bg.ts \
                src/qt/locale/prius_de.ts \
                src/qt/locale/prius_en.ts \
                src/qt/locale/prius_es.ts \
                src/qt/locale/prius_fi.ts \
                src/qt/locale/prius_fr.ts \
                src/qt/locale/prius_it.ts \
                src/qt/locale/prius_ja.ts \
                src/qt/locale/prius_pl.ts \
                src/qt/locale/prius_pt.ts \
                src/qt/locale/prius_ru.ts \
                src/qt/locale/prius_sk.ts \
                src/qt/locale/prius_sv.ts \
                src/qt/locale/prius_vi.ts \
                src/qt/locale/prius_zh_CN.ts \
                src/qt/locale/prius_zh_TW.ts
