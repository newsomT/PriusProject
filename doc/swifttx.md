...
* WebSocket: [https://github.com/priusproject/insight-api-prius#web-socket-api](https://github.com/priusproject/insight-api-prius#web-socket-api) 
* API: [https://github.com/priusproject/insight-api-prius#swifttx-transactions](https://github.com/priusproject/insight-api-prius#swifttx-transactions) 
...
By default, the Prius Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Prius Core daemon:
