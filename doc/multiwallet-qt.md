...
In order to support loading of multiple wallets in prius-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is prius.cpp.
...
Changes to prius.cpp
----------------------
prius.cpp is the entry point into prius-qt, and as such, will require some minor modifications to provide hooks for
