Contributing to Prius Core
============================

The Prius Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Prius Core project, and is not to be
confused with overall Prius Network Protocol consensus changes.

Whether a pull request is merged into Prius Core rests with the project merge
...
Patches that change Prius consensus rules are considerably more involved than
...
Where a patch set proposes to change the Prius consensus, it must have been
...
The project leader is the release manager for each Prius Core release.
